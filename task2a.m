clc,clear,close all
imshow('south korea.png', 'XData', [125.775*111, 129.9*111], 'YData', [38.528*111,34.18*111]);
hold on;
X_cars=zeros(1,1);
Y_cars=zeros(1,1);
y1=xlsread('1.xlsx','sheet3','B1:B16');
x1=xlsread('1.xlsx','sheet3','C1:C16');
y2=xlsread('1.xlsx','sheet3','D1:D16');
x2=xlsread('1.xlsx','sheet3','E1:E16');
x1=x1*111;
x2=x2*111;
y1=y1*111;
y2=y2*111;
car_num=xlsread('1.xlsx','sheet3','J1:J16');
n=size(x1);
n=n(1);
...
num=1;
while(i<=n)
    car_num(i,1)=ceil(car_num(i,1)/2/100/24);
    cn=car_num(i,1);
    j=1;
